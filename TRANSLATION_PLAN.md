...
| 3.8.16 | `integrations/builtin/credentials/` 第十六批 | 已完成 | Fortinet FortiGate、Freshdesk、Freshservice、Freshworks CRM、FTP、GetResponse |
| 3.8.17 | `integrations/builtin/credentials/` 第十七批 | 已完成 | Ghost、Git、GitHub、GitLab、Gong |
| 3.8.18 | `integrations/builtin/credentials/google/` | 已完成 | Google credentials README、OAuth generic、OAuth single service、Service account |
...
| 3.8.29 | `integrations/builtin/credentials/` 第二十八批 | 已完成 | Mailjet、Malcore、Mandrill、Marketstack、Matrix、Mattermost |
| 3.8.30 | `integrations/builtin/credentials/` 第二十九批 | 已完成 | Mautic、Medium、MessageBird、Metabase |
| 3.8.31 | `integrations/builtin/credentials/` 第三十批 | 已完成 | Microsoft |
...
| 3.8.46 | `integrations/builtin/credentials/` 第四十五批 | 已完成 | SearXNG、SeaTable、SecurityScorecard、Segment、Sekoia、SendGrid |
| 3.8.47 | `integrations/builtin/credentials/` 第四十六批 | 已完成 | Sendy、Sentry.io、Serp、ServiceNow、Shopify、Shuffler |
...
| 3.8.56 | `integrations/builtin/credentials/` 第五十五批 | 已完成 | Webhook、Wekan、WhatsApp Business Cloud、Wise、Wolfram\|Alpha、WooCommerce |
| 3.8.57 | `integrations/builtin/credentials/` 第五十六批 | 已完成 | WordPress、Workable、Wufoo、xAI、Xata、Xero |
...
| 3.9.8 | `integrations/builtin/app-nodes/` 第八批 | 已完成 | Google Sheets README、common issues、document operations |
| 3.9.9 | `integrations/builtin/app-nodes/` 第九批 | 已完成 | Google Sheets sheet operations |
| 3.9.10 | `integrations/builtin/app-nodes/` 第十批 | 已完成 | MySQL、Notion、Supabase README 和 common issues |
| 3.9.11 | `integrations/builtin/app-nodes/` 第十一批 | 已完成 | Postgres README、common issues |
| 3.9.12 | `integrations/builtin/app-nodes/` 第十二批 | 已完成 | WhatsApp Business Cloud README、common issues |
...
| 4.3 | `deploy/host-n8n/install-options/` 第一批 | 已完成 | 安装选项入口、npm、Docker |
...
| 4.12 | `deploy/host-n8n/configure-n8n/basic-configuration/configuration-examples/` 第二批 | 已完成 | Microsoft OAuth credentials 预配置；configuration-examples 已完成 |
| 4.13 | `deploy/host-n8n/configure-n8n/basic-configuration/use-environment-variables/` 第一批 | 已完成 | README、AI Assistant、binary data、credentials、database |
| 4.14 | `deploy/host-n8n/configure-n8n/basic-configuration/use-environment-variables/` 第二批 | 已完成 | endpoints、executions、expression engine、external data storage、external hooks |
| 4.15 | `deploy/host-n8n/configure-n8n/basic-configuration/use-environment-variables/` 第三批 | 已完成 | external secrets、insights、license、logs、nodes、OpenTelemetry |
| 4.16 | `deploy/host-n8n/configure-n8n/basic-configuration/use-environment-variables/` 第四批 | 已完成 | queue mode、security、source control、SSO、SSRF protection |
| 4.17 | `deploy/host-n8n/configure-n8n/basic-configuration/use-environment-variables/` 第五批 | 已完成 | timezone and localization、user management and 2FA、workflow history、workflows |
| 4.18 | `deploy/host-n8n/configure-n8n/basic-configuration/use-environment-variables/` 第六批 | 已完成 | task runners |
...
| 4.23 | `deploy/host-n8n/configure-n8n/security/` 第一批 | 已完成 | configure SSO、verify user emails、set up SSL、disable public API、harden task runners |
| 4.24 | `deploy/host-n8n/configure-n8n/security/` 第二批 | 已完成 | block specific nodes、control telemetry、SSRF protection、security audits |
...
| 4.29 | `deploy/host-n8n/understand-the-architecture/` | 已完成 | architecture overview、how n8n works、database structure；understand-the-architecture 已完成 |
...
| 5.10 | `administer/use-source-control-and-environments/` 第二批 | 已完成 | setup、push/pull、compare versions、move work、tutorial；source-control 已完成 |
| 5 | `administer/` | 已完成 | 管理与运维 |
