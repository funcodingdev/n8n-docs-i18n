---
title: TheHive Trigger node 文档
description: >-
  了解如何在 n8n 中使用 TheHive Trigger node。按照技术文档将 TheHive
...
在本页中，你可以找到 TheHive Trigger node 可响应的事件列表，以及更多相关资源链接。

{% hint style="info" %}
**TheHive 和 TheHive 5**

n8n 为 TheHive 提供了两个 node。如果你想使用 TheHive 的版本 3 或 4 API，请使用此 node（TheHive Trigger）。如果要使用版本 5，请使用 [TheHive 5 Trigger](n8n-nodes-base.thehive5trigger.md)。
{% endhint %}

{% hint style="info" %}
**示例和模板**

有关帮助你入门的使用示例和模板，请参阅 n8n 的 [TheHive Trigger integrations](https://n8n.io/integrations/thehive-trigger/) 页面。
{% endhint %}
...
n8n 为 TheHive 提供了一个 app node。你可以在[这里](../app-nodes/n8n-nodes-base.thehive.md)找到 node 文档。

在 n8n 网站上查看[示例 workflow 和相关内容](https://n8n.io/integrations/thehive-trigger/)。

有关该服务的更多信息，请参阅 TheHive 文档：
