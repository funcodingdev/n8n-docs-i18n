---
title: Embeddings Azure OpenAI node 文档
description: >-
  了解如何在 n8n 中使用 Embeddings Azure OpenAI node。按照技术文档将 Embeddings
  Azure OpenAI node 集成到你的 workflows 中。
contentType:
  - integration
  - reference
...
使用 Embeddings Azure OpenAI node 为给定文本生成 embeddings[^1]。

在本页中，你可以找到 Embeddings Azure OpenAI node 的 node 参数，以及更多相关资源链接。

{% hint style="info" %}
**Credentials**

你可以在[这里](../../credentials/azureopenai.md)找到此 node 的身份验证信息。
{% endhint %}
...
* **Model (Deployment) Name**：选择用于生成 embeddings 的 model (deployment)。
...
[浏览 Embeddings Azure OpenAI node 文档集成模板](https://n8n.io/integrations/embeddings-azure-openai)，或[搜索所有模板](https://n8n.io/workflows/)

## 相关资源 <a href="#related-resources" id="related-resources"></a>

有关该服务的更多信息，请参阅 [LangChain 的 OpenAI embeddings 文档](https://js.langchain.com/docs/integrations/text_embedding/azure_openai/)。
