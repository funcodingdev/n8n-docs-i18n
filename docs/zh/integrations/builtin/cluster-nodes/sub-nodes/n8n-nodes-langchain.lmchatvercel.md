---
title: Vercel AI Gateway Chat Model node 文档
description: >-
  了解如何在 n8n 中使用 Vercel AI Gateway Chat Model node。按照技术文档将 Vercel
  AI Gateway Chat Model node 集成到你的 workflows 中。
contentType:
  - integration
  - reference
priority: high
...
使用 Vercel AI Gateway Chat Model node 将 AI Gateway chat models 与 conversational agents 配合使用。

在本页中，你可以找到 Vercel AI Gateway Chat Model node 的 node 参数，以及更多相关资源链接。

{% hint style="info" %}
**Credentials**

你可以在[这里](../../credentials/vercel.md)找到此 node 的身份验证信息。
{% endhint %}
...
n8n 会从 AI Gateway 动态加载 models，你只会看到你的账号可用的 models。
...
[浏览 Vercel AI Gateway Chat Model node 文档集成模板](https://n8n.io/integrations/vercel-ai-gateway-chat-model)，或[搜索所有模板](https://n8n.io/workflows/)

## 相关资源 <a href="#related-resources" id="related-resources"></a>

由于 Vercel AI Gateway 与 OpenAI API-compatible，你可以参阅 [LangChain 的 OpenAI 文档](https://js.langchain.com/docs/integrations/chat/openai/)了解该服务的更多信息。
