---
title: Mistral Cloud Chat Model node 文档
description: >-
  了解如何在 n8n 中使用 Mistral Cloud Chat Model node。按照技术文档将 Mistral
  Cloud Chat Model node 集成到你的 workflows 中。
contentType:
  - integration
  - reference
priority: medium
...
使用 Mistral Cloud Chat Model node 将 Mistral Cloud 的 chat models 与 conversational agents[^1] 结合使用。

在本页中，你可以找到 Mistral Cloud Chat Model node 的 node 参数，以及更多相关资源链接。
...
* **Model**：选择用于生成 completion 的 model。n8n 会从 Mistral Cloud 动态加载 models，你只会看到你的账号可用的 models。
...
* **Enable Safe Mode**：通过在 completion 开头注入 safety prompt 启用 safe mode。这有助于防止 model 生成 offensive content。
* **Random Seed**：输入用于 random sampling 的 seed。如果设置，不同调用会生成 deterministic results。

## 模板和示例 <a href="#templates-and-examples" id="templates-and-examples"></a>

[浏览 Mistral Cloud Chat Model node 文档集成模板](https://n8n.io/integrations/mistral-cloud-chat-model)，或[搜索所有模板](https://n8n.io/workflows/)

## 相关资源 <a href="#related-resources" id="related-resources"></a>

有关该服务的更多信息，请参阅 [LangChain 的 Mistral 文档](https://js.langchain.com/docs/integrations/chat/mistral)。
