---
title: Azure OpenAI Chat Model node 文档
description: >-
  了解如何在 n8n 中使用 Azure OpenAI Chat Model node。按照技术文档将 Azure OpenAI
...
使用 Azure OpenAI Chat Model node 将 OpenAI 的 chat models 与 conversational agents[^1] 配合使用。

在本页中，你可以找到 Azure OpenAI Chat Model node 的 node 参数，以及更多相关资源链接。
...
[浏览 Azure OpenAI Chat Model node 文档集成模板](https://n8n.io/integrations/azure-openai-chat-model)，或[搜索所有模板](https://n8n.io/workflows/)

## 相关资源 <a href="#related-resources" id="related-resources"></a>

有关该服务的更多信息，请参阅 [LangChain 的 Azure OpenAI 文档](https://js.langchain.com/docs/integrations/chat/azure)。
